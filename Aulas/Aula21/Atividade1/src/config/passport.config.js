...
const initializePassport = () => {
    passport.use('github', new GitHubStrategy({
        clientID: 'Iv23liyrwp5Rj5KmYt50', // ID do cliente fornecido pelo GitHub OAuth
        clientSecret: '051423009b5af13353307b7cffb44930e834c110', // Chave secreta do cliente fornecida pelo GitHub OAuth
