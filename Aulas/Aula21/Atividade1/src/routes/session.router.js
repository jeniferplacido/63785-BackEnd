...
router.post('/registro', async (req, res) => {
    ...
    console.log('Usuário registrado com sucesso!', access_token);
});
...
router.get('/github', passport.authenticate('github', scope = ['user:email'])); // Rota para autenticação com GitHub
