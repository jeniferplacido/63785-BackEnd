...
async function main() {
    ...
    await userManager.criarUsuario("Ale", "Rezende", 18, "Backend"); // Cria um novo usuário
    const user = await userManager.consultaByName("Jeni", "Ale"); // Encontra o usuário pelo nome
